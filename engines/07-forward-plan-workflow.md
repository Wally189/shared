...
## Engineering rule
Once the applicable date rule is known, repeated date arithmetic should be implemented and tested deterministically in Excel, Power Automate or code rather than relying on an LLM to count days.
